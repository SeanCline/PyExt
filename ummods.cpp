...
//
//----------------------------------------------------------------------------
EXT_COMMAND(ummods, "Output the user-mode OS loaded module list", "{;e,o,d=@$peb;peb;PEB address}")
{
	...
	ExtRemoteTypedList LdrList2 = ExtNtOsInformation::GetUserLoadedModuleList();
